...
type ButtonVariant = "primary" | "dark" | "outline" | "outline-light";
type ButtonSize = "sm" | "md";

export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  /**
   * primary: 브랜드 라임 pill · dark: 잉크 pill ·
   * outline: 투명+white 보더(다크 배경용) ·
   * outline-light: 투명+hairline 보더(라이트/카드 배경 위 보조 버튼)
   */
...
const VARIANT: Record<ButtonVariant, string> = {
  ...
  "outline-light":
    "bg-transparent border border-hairline text-ink-soft hover:border-brand",
};
